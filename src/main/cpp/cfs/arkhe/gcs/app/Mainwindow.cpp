                            ...
                            QString styleSheetFileName)
{
    ...
    case GCS_MAINWINDOW_STYLE_NATIVE:
        ...
        {
            // qApp->setStyleSheet("");
            // showInfoMessage(tr("Please restart QGroundControl"), tr("Please restart QGroundControl to switch to fully
            // native look and feel. Currently you have loaded Qt's plastique style."));
        }
