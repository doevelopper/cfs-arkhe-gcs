...
void MultiScreenManagement::screenAdded (QScreen * screen)
{
    ...
    LOG4CXX_INFO(logger,
                 "Screen added:" << screen->name().toStdString() <<" Siblings: "<<screen->virtualSiblings().count() <<
                 " First:" <<
                 (screen->virtualSiblings().isEmpty() ? "None" :
                  screen->virtualSiblings().first()->name().toStdString()));
}
...
void MultiScreenManagement::sreensInfo ()
{
    ...
    foreach (QScreen * screen, QGuiApplication::screens())
    {
        ...
        LOG4CXX_INFO(logger,
                     "Available geometry: X=" << screen->availableGeometry().x() <<" Y="<<
                     screen->availableGeometry().y() << " Resolutions: "<<
        ...
        LOG4CXX_INFO(logger,
                     ...
                     screen->availableVirtualGeometry().y() << " Res: "<< screen->availableVirtualGeometry().width() <<
                     "x" <<
        ...
        LOG4CXX_INFO(logger,
                     "Geometry X:" << screen->geometry().x() <<" Y:"<< screen->geometry().y() <<" Res: "<<
