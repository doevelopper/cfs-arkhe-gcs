...
#ifndef CFS_ARKHE_GCS_UTILS_PIMPLPTR_HPP
#define CFS_ARKHE_GCS_UTILS_PIMPLPTR_HPP
...
namespace cfs::arkhe::gcs::utils
{
     ...
     * private:
     *
     *     cfs::utils::arkhe::gcs::PimplPtr<struct MyClassPrivate> d;
     * };
     * @endcode
     *
     * @code
...
/*!
   ...
   @brief Utility macros for handling private implementations. It is in addition
     to QtGlobal: Q_DECLARE_PRIVATE, Q_DECLARE_PUBLIC,Q_D and Q_Q.
 */
