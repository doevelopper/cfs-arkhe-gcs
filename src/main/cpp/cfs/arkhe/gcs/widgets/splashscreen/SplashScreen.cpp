...

{
    ...
    QString titleText = QString(QApplication::applicationName()).replace(QString("-testnet"), QString(""),
                                                                         Qt::CaseSensitive); // cut of testnet, place it
                                                                                             // as single object further
                                                                                             // down
    QString versionText = "QString";                                                         //("Version %1
                                                                                             // ").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText1 = QChar(0xA9) + QString(" 2015-%1 ").arg(COPYRIGHT_YEAR) + QString(tr(
                                                                                                  "The GCS  developers"));
    QString copyrightText2 = QChar(0xA9) + QString(" 2016-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The GCS developers"));
    QString copyrightText3 = QChar(0xA9) + QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr(
                                                                                                  "The ARKHE GCS  developers"));
...
void SplashScreen::progressBar()
{
    ...
    m_progressBar->setStyleSheet(
        "QProgressBar{border: 2px solid rgb(216,216,218); border-radius: 4px; text-align:center; background:rgb(50, 50, 50);}"
